    ...
    <Stack direction={['column','row']} h={'100vh'}>
      ...
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
          ...
          <Text>This is a sample video for testing purposes..This small part of the window is called 'Description'</Text>
        </VStack>
      </VStack>
...

      {
        videosArr.map((item,index)=>(
          <Button variant={'ghost'} colorScheme='blue' onClick={()=>SetVideoSrc(item)}>Lecture no {index+1}</Button>
        ))
      }
